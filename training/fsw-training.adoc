...
See: org.switchyard.label.Label

* prefix: org.switchyard.label.
* label_type: http,
* label_name: xxx

Label: prefix.<label_type>.<label_name>

EndpointLabels names: AMQP, ATOM, DIRECT, FILE, FTP, FTPS, HTTP, JCA, JMS, JPA, MAIL, MOCK, QUARTZ, REST, SEDA, SFTP, SOAP, SQL, TCP, TIMER, UDP, URI

Label: org.switchyard.label.Label.endpoint.<name>
